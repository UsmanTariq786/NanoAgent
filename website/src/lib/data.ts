...
export const siteConfig = {
  ...
  issues: "https://github.com/getnanoai/NanoAgent/issues",
  discussions: "https://github.com/getnanoai/NanoAgent/discussions",
...
export const footerColumns: FooterColumn[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Organization", href: siteConfig.creator },
      { label: "@getnanoai", href: siteConfig.creator },
    ],
  },
];
...
export const installPanels: InstallPanel[] = [
  {
    ...
    commands: [
      ...
      { id: "pw", cmd: "irm https://raw.githubusercontent.com/getnanoai/NanoAgent/master/scripts/install.ps1 | iex" },
      { id: "curl", cmd: "curl -fsSL https://raw.githubusercontent.com/getnanoai/NanoAgent/master/scripts/install.sh | bash" },
    ],
    actions: [
      { label: "Read the docs", href: "/docs#first-run", variant: "primary" },
...
export const docsSidebar: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      { label: "Setup & Connection", href: "#gateway-overview" },
      { label: "Custom Scripts & Apps", href: "#gateway-integration" },
      { label: "Dashboard & Spend Controls", href: "#gateway-policy" },
    ],
  },
  {
    title: "▤ NanoForge (Builder)",
    items: [
      { label: "App Builder & Prompts", href: "#forge-overview" },
      { label: "Extending Apps Locally", href: "#forge-containers" },
    ],
  },
];
...
export const docSections = [
  ...
  { id: "gateway-overview", heading: "Gateway Setup & Connection" },
  { id: "gateway-integration", heading: "Connecting Custom Apps & Scripts (Optional)" },
  { id: "gateway-policy", heading: "Gateway Dashboard & Spend Controls" },
